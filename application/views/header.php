...
<nav class="autoBackgroud navbar">
    <div class="container ">
        <span class="site-title title-font left"><a href="<?php echo URL; ?>new">Secure Notes</a></span><span
            class="right"><a href="<?php echo URL; ?>new"><img
                    src="<?php echo URL; ?>imgs/plus.png"/></a><!--<img src="<?php echo URL; ?>imgs/view.png"/>--></span>
    </div>
</nav>
