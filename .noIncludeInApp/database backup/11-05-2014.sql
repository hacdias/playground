...
--
-- Host: 127.0.0.1
-- Generation Time: 11-Maio-2014 às 13:16
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `bio` varchar(500) NOT NULL DEFAULT 'Vai às opções para editar.',
...
(5, 'Teste', 'teste', 'UG5tWDdsL0ZnSmoxMnRnQWQyREROZz09', 'blue', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent lorem neque, suscipit venenatis velit a, gravida ullamcorper leo. Fusce molestie at enim vel consequat. Phasellus in vehicula mauris. Pellentesque nisi lectus, viverra molestie tincidunt vitae, mattis in lorem. Sed lacinia mi non turpis interdum suscipit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus in lacus ut orci rhoncus rhoncus.', 1),
(6, 'Administrador', 'admin', 'T2ZPTkdDR0hsOUFoZFZlWVVFY05Kdz09', 'orange', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent lorem neque, suscipit venenatis velit a, gravida ullamcorper leo. Fusce molestie at enim vel consequat. Phasellus in vehicula mauris. Pellentesque nisi lectus, viverra molestie tincidunt vitae, mattis in lorem. Sed lacinia mi non turpis interdum suscipit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus in lacus ut orci rhoncus rhoncus.', 0),
(7, 'User', 'user', 'TnQxa2hwa3YxQ3pGZGpRMkp6NGc3Zz09', 'blue', 'Vai às opções para editar.', 1),
(8, 'Asa', 'asa', 'TytYd09mVmdEUWVWb25uVVNxLzZTQT09', 'blue', 'Vai às opções para editar.', 1),
(10, 'Vaca', 'Vaca', 'WFJmMWtnVDVDeWhlM2MrTnJUbERVQT09', 'blue', 'Vai às opções para editar.', 1);
